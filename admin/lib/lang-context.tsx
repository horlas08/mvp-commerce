...
export const translations = {
  en: {
    ...
    cartType: "Cart Type",
    contactUserTitle: "Contact User Regarding Order",
    messagePlaceholder: "Type your message...",
    adjustWalletTitle: "Adjust Wallet Balance",
    adjustmentType: "Adjustment Type",
    creditOption: "Credit (Add)",
    debitOption: "Debit (Deduct)",
    ...
    selectTicketDesc: "Select a support ticket from the list to manage and reply.",
    closeTicket: "Close Ticket",
    closeTicketConfirm: "Are you sure you want to close this ticket? No more replies can be sent once closed.",
  ...
  ar: {
    ...
    cartType: "نوع السلة",
    contactUserTitle: "الاتصال بالمستخدم بشأن الطلب",
    messagePlaceholder: "اكتب رسالتك هنا...",
    adjustWalletTitle: "تعديل رصيد المحفظة",
    adjustmentType: "نوع التعديل",
    creditOption: "شحن (إضافة)",
    debitOption: "خصم",
    reasonPlaceholder: "سبب التعديل...",
    amount: "المبلغ",
    pendingRefunds: "طلبات استرداد معلقة",
    all: "الكل",
