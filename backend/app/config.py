...
SITE_CONFIGS: Dict[str, ScraperConfig] = {
    ...
    "aliexpress": ScraperConfig(
        ...
        hide_selectors=[
            ...
            "[class*='mask_']",
            "[class*='dialogWrap_']",
            "[class*='dialogContent_']",
            "[class*='close_']",
            "[class*='closeIcon_']",
            "[class*='welcomeDialog']",
            # --- Bottom tab bar / footer-bar ---
            "#footer-bar",
            ".footer-bar",
            "[class*='footer-bar']",
            "[class*='footerBar']",
    ...
    "alibaba": ScraperConfig(
        ...
        hide_selectors=[
            ...
            "[class*='ar-signin']",
            "[class*='ar-register']",
            # --- "Open in app" / download-app popups & smart banners ---
            # These interstitials deep-link out to the native app / Play Store.
            # We hide them (and the redirect itself is blocked in the webview).
            ".app-guide",
            ".app-banner",
            ".app-download",
            ".download-app",
            ...
            "[data-spm*='openapp']",
            "[data-spm*='app_guide']",
            # --- m.alibaba.com mobile login nag banner ---
            ".msite-login-banner",
            ".icbu-m-login-banner",
